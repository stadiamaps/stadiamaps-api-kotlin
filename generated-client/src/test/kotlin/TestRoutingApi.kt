...
internal class TestRoutingApi {
    ...
    @Test
    fun testRouteWithNavigationAids() {
        val req = RouteRequest(
            id = "route",
        ...
        assertEquals(Route200Response.Code.Ok, body.code)
    ...
    fun testTimeDistanceMatrix() {
        ...
        assertEquals(RoutingLongUnits.kilometers, body.units)
    ...
    fun testTraceAttributes() {
        ...
        assertEquals(req.id, body.id)
        assertEquals(RoutingLongUnits.miles, body.units)
